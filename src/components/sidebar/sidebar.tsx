  ...
  return (
    <aside className={`sidebar ${isExpanded ? "expanded" : "collapsed"}`}>
      <div className="sidebar-header">
        {isExpanded && <img src="./src/assets/LogoPointMedia.png" alt="Logo" />}
        <svg
      ...
      <nav className="sidebar-nav">
        <div className="nav-item" onClick={() => navigate("/visao-geral")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
          ...
          {isExpanded && <span className="pagesNameSidebar">Visão Geral</span>}
        </div>
        <div className="nav-item" onClick={() => navigate("/candidatos")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
            ...
            fill="#FFFFFF"
          >
            <path d="M40-272q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v32q0 33-23.5 56.5T600-160H120q-33 0-56.5-23.5T40-240v-32Zm698 112q11-18 16.5-38.5T760-240v-40q0-44-24.5-84.5T666-434q51 6 96 20.5t84 35.5q36 20 55 44.5t19 53.5v40q0 33-23.5 56.5T840-160H738ZM247-527q-47-47-47-113t47-113q47-47 113-47t113 47q47 47 47 113t-47 113q-47 47-113 47t-113-47Zm466 0q-47 47-113 47-11 0-28-2.5t-28-5.5q27-32 41.5-71t14.5-81q0-42-14.5-81T544-792q14-5 28-6.5t28-1.5q66 0 113 47t47 113q0 66-47 113Z" />
          </svg>
          {isExpanded && <span className="pagesNameSidebar">Candidatos</span>}
        </div>
        <div className="nav-item" onClick={() => navigate("/vagas")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
          ...
          {isExpanded && <span className="pagesNameSidebar">Vagas</span>}
        </div>
        <div className="nav-item" onClick={() => navigate("/configuracoes")}>
          ...
          {isExpanded && (
            <span className="pagesNameSidebar">Configurações</span>
          )}
        </div>
      </nav>
      ...
      <div className="sidebar-footer">
        <div className="user-info">
          ...
          {isExpanded && (
            <div className="user-details">
              <p className="user-name">Nome Sobrenome</p>
              <p className="user-email">emailUser@gmail.com</p>
            </div>
          )}
        </div>
        <div className="nav-item logout" onClick={() => console.log("Logout")}>
          ...
          {isExpanded && <span className="logoutSidebar">Logout</span>}
        </div>
      </div>
    </aside>
  );
